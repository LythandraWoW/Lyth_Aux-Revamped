-- This file is the main aux-addon.lua after integrating aux_merchant_prices.lua.
...
-- This is the block where the event handlers are set up.
-- The PLAYER_LOGIN handler is where we will add the merchant price logic.
do
	...
	event_frame:SetScript('OnEvent', function()
		...
		elseif event == 'PLAYER_LOGIN' then
			-- --- START of merged code from aux_merchant_prices.lua ---
            local VERSION = 2
...
-- Other functions from aux-addon.lua would follow here...
